...
class PrintASequence
{
    static void Main()
    {
        ...
        int number = 2;
        // инициализираме променлива за "таван" на бройката на редицата
        int sequenceNumber = 1000;
        // правим цикъл за който да гледа дали не сме прехвърли максималната стойност
        // с "int count = 1" задаваме стоиност на променливата с която ще следим
        ...
        for (int count = 1; count <= sequenceNumber; count++)
        {
            ...
            {
                // не се дели и проверяваме дали "count" не е по голяма от "sequenceNumber" т.е максималната стойност
                if (count < sequenceNumber)
                {
